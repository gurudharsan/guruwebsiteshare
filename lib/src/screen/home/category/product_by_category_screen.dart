...
class ProductByCategory extends StatefulWidget {
  ProductByCategory(
      {Key? key, required this.id, this.title, this.subtitle = ''})
      : super(key: key);
  final int? id;
  final String? title;
  String? subtitle;
...
class _ProductByCategoryState extends State<ProductByCategory> {
  ...
  void initState() {
    super.initState();
    fc = Get.put(ProductsFilterController(
            ...
            return Stack(
              children: [
                fc.isFiltering.value
                    ...
                    : fc.searchFilteredData.isNotEmpty &&
                            fc.mainFilterType.value == 1
                        ? Padding(
                        ...
                        : fc.filteredData.isNotEmpty &&
                            ...
                            : fc.mainFilterType.value == 2 &&
                                    fc.keyWord.isNotEmpty &&
                                    fc.reagentsSearchFilteredData.isEmpty
                                ? const Center(
                                    child: Text(
                                        'Search do not match any products'))
                                : fc.mainFilterType.value == 2 &&
                                        fc.keyWord.isNotEmpty &&
                                        fc.reagentsSearchFilteredData.isNotEmpty
                                    ? Padding(
                                        padding: EdgeInsets.only(top: 200.h),
                                        child: GridView.builder(
                                          gridDelegate:
                                    ...
                                    : fc.mainFilterType.value == 2 &&
                                            fc.filterCheck() &&
                                            fc.reagentsFilteredData.isEmpty
                                        ? const Center(
                                            child: Text('No matching products'))
                                        : fc.mainFilterType.value == 2 &&
                                                fc.reagentsFilteredData
                                                    .isNotEmpty
                                            ? Padding(
                                                padding:
                                                ...
                                                : fc.reagents.isNotEmpty &&
                                                    ...
                                                    ? Padding(
                                                        ...
                                                        child: SmartRefresher(
                                                          ...
                                                          onLoading: () {
                                                            if (fc.selectedBrandFilters.isNotEmpty ||
                                                                fc.selectedParameterFilters
                                                                    .isNotEmpty ||
                                                                fc.selectedProductFilters
                                                                    .isNotEmpty) {
                                                              return;
                                                            }
                ...
                (fc.instruments.isNotEmpty || fc.reagents.isNotEmpty) &&
                        (fc.mainFilterType.value == 1 &&
                            (fc.instrumentFilters.isNotEmpty ||
                                fc.immunologyInstrumentFilters.isNotEmpty))
                    ? Positioned(
                        top: 130.h,
                        left: MediaQuery.of(context).size.width - 160.w,
                        child: Container(
  ...
  showReagentsFilterBottomsheet() {
    ...
    showModalBottomSheet<dynamic>(
        ...
        builder: (BuildContext context) {
          return fc.mainFilterType.value == 2
              ? WillPopScope(
                  onWillPop: () {
                  ...
                  child: SizedBox(
                    ...
                    child: Stack(
                      children: [
                        Padding(
                          padding: EdgeInsets.only(
                              top: 20.h, left: 20.w, right: 20.w, bottom: 60.h),
                            ...
                            child: Column(
                              ...
                              children: [
                                                  ...
                                                  child: CheckboxListTile(
                                                      ...
                                                      onChanged: (v) {
                                                        ...
                                                        if (fc
                                                          ...
                                                          fc.selectedProductFilters
                                                              .remove(element);
                                                          if (fc.selectedProductFilters.isEmpty &&
                                                              fc.selectedParameterFilters
                                                                  .isEmpty &&
                                                              fc.selectedBrandFilters
                                                                  .isEmpty) {
                                                            fc.filteredData
                                                                .value = [];
                                                          }
                                            ...
                                            return ConstrainedBox(
                                              ...
                                              child: CheckboxListTile(
                                                  controlAffinity:
                                                      ListTileControlAffinity
                                                          .leading,
                                                  value: fc.selectedBrandFilters
                                                      .contains(element),
                                                  title: Text(element),
                                                  onChanged: (v) {
                                                    fc.filtersChanged.value =
                                                        true;
                                                    if (fc.selectedBrandFilters
                                                        .contains(element)) {
                                                      fc.selectedBrandFilters
                                                          .remove(element);
                                                      if (fc.selectedProductFilters.isEmpty &&
                                ...
                                DropdownButton2(
                                    ...
                                    onChanged: (v) {
                                      fc.filtersChanged.value = true;
                                      if (fc.selectedParameterFilters
                                          .contains(v)) {
                                ...
                                Obx(() {
                                  return Wrap(
                                    spacing: 10.w,
                                    runSpacing: 10.h,
                                    children: fc.selectedProductFilters
                                        .map((element) {
                                      return InkWell(
                                        onTap: () {
                                          fc.filtersChanged.value = true;
                                          ...
                                          if (fc.selectedProductFilters
                                              ...
                                              fc.selectedParameterFilters
                                                  .isEmpty &&
                                              fc.selectedBrandFilters.isEmpty) {
                                ...
                                Obx(() {
                                  return Wrap(
                                    ...
                                    runSpacing: 10.h,
                                    children:
                                        fc.selectedBrandFilters.map((element) {
                                      return InkWell(
                                        onTap: () {
                                          fc.filtersChanged.value = true;
                                          fc.selectedBrandFilters
                                ...
                                Obx(() {
                                  return Wrap(
                                    spacing: 10.w,
                                    runSpacing: 10.h,
                                    children: fc.selectedParameterFilters
                                        .map((element) {
                                      return InkWell(
                                        onTap: () {
                                          fc.filtersChanged.value = true;
                          ...
                          child: Column(
                            children: [
                              ...
                              Wrap(
                                ...
                                spacing: 10.w,
                                children:
                                    fc.immunologyInstrumentFilters.map((e) {
                                  bool selected = fc
                                      .selectedImmunologyInstrumentFilters
                                      .contains(e);
                                  return InkWell(
                                    onTap: () {
                                      if (fc.selectedImmunologyInstrumentFilters
                                          .contains(e)) {
                                        fc.selectedImmunologyInstrumentFilters
                                            .remove(e);
                                        fc.immunologyInstrumentsFilter();
                                        return;
                                      }
